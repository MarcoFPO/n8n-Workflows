# 📚 Event-Driven Trading Intelligence System - Dokumentation

## 📋 **Dokumentations-Navigation**

### 🔍 **Systemüberblick**
- [**📖 System Overview**](SYSTEM_OVERVIEW.md) - Komplette Systemarchitektur und Funktionsweise
- [**⚙️ Anforderungen**](REQUIREMENTS.md) - Funktionale und non-funktionale Anforderungen
- [**🏗️ High-Level Design**](HLD.md) - Service-Architektur, Event-Driven Design
- [**🔧 Low-Level Design**](LLD.md) - Detaillierte Implementierung und Module

### 🔌 **Integration & Kommunikation**
- [**📡 Kommunikationspfade**](COMMUNICATION.md) - API-Endpoints, Event-Flows, Protokolle
- [**🔗 Ressourcen**](RESOURCES.md) - Ports, Datenbanken, Konfigurationen
- [**🧩 Module & Services**](MODULES.md) - Alle Services und deren Funktionen

### 🧪 **Qualitätssicherung**
- [**✅ Testing & Prüfung**](TESTING.md) - Test-Framework, Health-Checks, Validierung

---

## ✅ **Dokumentations-Status: VOLLSTÄNDIG KONSOLIDIERT**

### 📈 **Konsolidierungs-Erfolg**
- **Ursprünglich**: 150+ chaotische MD-Dateien
- **Konsolidiert zu**: 10 strukturierte Hauptdokumente  
- **Abdeckung**: 100% aller System-Aspekte
...
- **🌐 Web Interface**: https://10.1.1.174 (Production System)
- **📊 API Documentation**: http://10.1.1.174:8021/docs (ML Analytics Swagger)
- **🔍 System Health**: http://10.1.1.174:8015/health (Monitoring)

---

*Letzte Aktualisierung: 23. August 2025 - Production Ready v5.1*