...
async def get_performance_comparison(timeframe: str):
    ...
    try:
        ...
        # Use production server IP and correct port for Unified Profit Engine
        profit_engine_host = os.getenv("PROFIT_ENGINE_HOST", "10.1.1.174")
        profit_engine_port = os.getenv("PROFIT_ENGINE_PORT", "8025")
        api_url = f"http://{profit_engine_host}:{profit_engine_port}/api/v1/comparison/soll-ist"
