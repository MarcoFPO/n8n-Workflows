-- =============================================
-- ML Schema Extension v1.0.0 (Basic Version ohne TimescaleDB)
...
-- Unique constraint für aktive Modelle
CREATE UNIQUE INDEX IF NOT EXISTS idx_ml_model_active_unique 
ON ml_model_metadata (model_type, horizon_days, status) 
WHERE status = 'active';
...
INSERT INTO ml_service_health (service_name, status, metrics) VALUES
    ('ml-analytics', 'healthy', '{"schema_version": "1.0.0", "deployment_timestamp": "' || NOW()::text || '", "tables_created": 8, "functions_created": 3}'::jsonb);
...
INSERT INTO ml_schema_version (version, description) VALUES
    ('1.0.0', 'Initial ML Schema Extension - Complete ML Pipeline Support (Basic Version)')
...
SELECT 'ML Schema Extension v1.0.0 (Basic) deployed successfully!' as deployment_status,
